...
if(isset($_POST['submit'])){
    ...
    if($result){
        header("Location: driver.php?msg=New record created successfully");
    }
}
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        ...
        <div class="container d-flex justify-content-center">
            <form action="tambah-driver.php" method="post" style="width:50vw; min-width:300px">
                <div class="row mb-3">
                    <div class="col">
                        <label class="form-label"> Id Driver</label>
                        <input type="text" class="form-control" name="id_driver" placeholder="Id Driver">
                    </div>
                    <div class="col">
