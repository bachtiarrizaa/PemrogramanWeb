...
<div class="container my-5" style="overflow-x: auto;">
    ...
    <h3 class="mb-0">Pendapatan Driver</h3>
    <form method="GET">
    ...
    <table class="table table-hover">
        ...
        if(isset($_GET['bulan'])){
            $bulan = $_GET['bulan'];
            $query = "SELECT driver.nama,  MONTHNAME(trans_upn.tanggal) as bulan, trans_upn.jumlah_km, SUM(trans_upn.jumlah_km * 3000) as total_gaji_bulanan 
                        FROM trans_upn 
