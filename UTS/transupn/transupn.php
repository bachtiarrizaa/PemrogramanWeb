...
<div class="container my-5" style="overflow-x: auto;">
    ...
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="mb-0">Data Trans UPN</h3>
        <a href="tambah-transupn.php" class="btn btn-primary"><i class="fas fa-plus"></i>Tambah Data</a>
    </div>
    <hr>
    <table class="table table-hover">
        ...
        while($row = mysqli_fetch_assoc($result)):
            ...
            <tr>
                ...
                <td><?= $row['tanggal'] ?></td>
                <td>
                    <a href="update-transupn.php?id_trans_upn=<?= $row['id_trans_upn'] ?>" class="text-warning me-3"><i class="fas fa-pen-to-square"></i></a>
                    <a href="delete-transupn.php?id_trans_upn=<?= $row['id_trans_upn'] ?>" class="text-danger"><i class="fas fa-trash"></i></a>
                </td>
            </tr>
        <?php endwhile; ?>
        </tbody>
